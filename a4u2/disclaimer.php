    ...
    <body data-spy="scroll" data-target="#header">
                        ...
                        <nav class="navbar navbar-default zero_mp ">
                            ...
                            <div class="collapse navbar-collapse zero_mp" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right main_menu">
                                    ...
                                    <li class="active"><a href="disclaimer.php">Disclaimer</a></li>
        ...
        <section id="slider">
            <div id="carousel-example-generic" class="carousel slide carousel-fade" data-ride="carousel" data-interval="3000">
               ...
               <div class="col-md-12" style="background-image: url('img/img1.jpg');padding: 10%;text-align: center;color: #fff"><h1 style="margin-bottom: 5%">Disclaimer</h1>
                   <p>
                      If you require any more information or have any questions about our site's disclaimer, please feel free to contact us by email at avimujmule@gmail.com<br>
Disclaimers for Desi Gharelu Nuskhe<br>
All the information on this website - www.aayurved4u.com - is published in good faith and for general information purpose only. Desi Gharelu Nuskhe does not make any warranties about the completeness, reliability and accuracy of this information. Any action you take upon the information you find on this website (Desi Gharelu Nuskhe), is strictly at your own risk. Desi Gharelu Nuskhe will not be liable for any losses and/or damages in connection with the use of our website.<br>
                ...
                <div class="row text-center">
                    <div class="col-md-6">
                        <div class="copyright" style="text-align: center;">
                            <p>All rights reserved<br><a href="http://www.ayurved4u.com">www.aayurved4u.com</a>  2018-2019
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="designer">
